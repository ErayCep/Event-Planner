...
public class EventAppTest {
   ...
   *
   * @details This method redirects the System.in and System.out streams to simulate user input and capture the output. It calls the main method of EventApp with a valid argument and asserts the expected behavior based on the output.
   */
  @Test
  public void testMainSuccess() {
    ...
    // Call the main method of EventApp
    EventApp.main(args);
  ...
  /**
   * @brief Test method to validate the object creation of EventApp.
   *
   * @details This method creates an instance of the EventApp class and asserts the successful creation of the object.
   */
  @Test
  public void testMainObject() {
    // Creating an instance of EventApp
   ...
   *
   * @details This method redirects the System.in and System.out streams to simulate user input and capture the output. It calls the main method of EventApp with an invalid argument and asserts the expected behavior based on the output.
   */
  @Test
